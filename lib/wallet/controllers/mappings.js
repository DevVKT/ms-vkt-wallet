...
// For Admin
router.get("/isBlackList", emptyValidator, actions.CheckLocked);

router.post("/transferFromByPk", emptyValidator, actions.transferFromByPk);
router.post("/approveByTransferFee", emptyValidator, actions.approveByTransferFee);
router.post("/lockWalletList", emptyValidator, actions.lockWalletList);

router.post("/airdrop", actions.airdrop);
